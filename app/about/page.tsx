...
import { StoreResponse, APIResponse, PaginatedResponse } from "@/types";
...
export default async function AboutPage() {
  ...
  const storesData = await getStores({ limit: 3, isActive: true }).catch((): APIResponse<PaginatedResponse<StoreResponse>> | null => null);
