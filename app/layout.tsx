...
export const metadata: Metadata = {
  ...
  description: 'Order delicious handcrafted pizzas from Pizza Space. Fresh ingredients, fast delivery across London. Experience authentic Italian flavors with our premium selection of pizzas, sides, and desserts.',
  keywords: [
    'pizza',
    'pizza delivery',
  ...
  openGraph: {
    ...
    description: 'Order delicious handcrafted pizzas from Pizza Space. Fresh ingredients, fast delivery across London. Experience authentic Italian flavors.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
