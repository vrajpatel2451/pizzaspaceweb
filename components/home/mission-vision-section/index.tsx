...
function SectionHeader() {
  return (
    ...
    >
      ...
      >
        <span className="h-px w-8 bg-gradient-to-r from-transparent to-orange-500 dark:to-orange-400" />
        <span className="text-overline text-orange-600 dark:text-orange-400 tracking-widest">
          Why We Do It
        </span>
        <span className="h-px w-8 bg-gradient-to-l from-transparent to-orange-500 dark:to-orange-400" />
      </motion.div>
