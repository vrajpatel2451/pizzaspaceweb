...
export function TopInfoBar({ className }: TopInfoBarProps) {
  return (
    <div
      className={cn(
        "w-full bg-secondary text-secondary-foreground py-2 text-xs sm:text-sm",
        "border-b border-secondary-foreground/10",
        className
      )}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <Link
              href="/stores"
              className="hidden md:flex items-center gap-1.5 text-secondary-foreground/80 hover:text-primary transition-colors"
            >
            ...
            <div className="flex items-center gap-1">
              {socialLinks.map((social) => (
                <Link
                  ...
                  className="p-1.5 rounded-full text-secondary-foreground/60 hover:text-primary hover:bg-primary/10 transition-all duration-200"
