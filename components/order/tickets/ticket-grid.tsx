    ...
    return (
      ...
      >
        ...
        <div className="relative mb-8">
          ...
          <motion.div
            className="relative rounded-2xl bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/20 p-8 border border-red-200/50 dark:border-red-500/20"
  ...
  return (
    ...
    >
      {tickets.map((ticket, index) => (
        <motion.div key={ticket._id} variants={shouldReduceMotion ? {} : itemVariants} role="listitem">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4" role="status" aria-label="Loading tickets">
      {Array.from({ length: count }).map((_, i) => (
        <motion.div
          ...
          className="rounded-xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-900/50 overflow-hidden"
        >
